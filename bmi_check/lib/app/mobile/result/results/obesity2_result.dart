...
class Obesity2Result implements BmiResult {
  @override
  BmiResultModel result(BuildContext context) {
    return BmiResultModel(
      title: AppLocalizations.of(context)!.obesity2ResultTitle,
      description: AppLocalizations.of(context)!.obesity2ResultDescription,
    );
  }
}
